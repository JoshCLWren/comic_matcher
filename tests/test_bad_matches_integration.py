...
class TestBadMatchesIntegration:
    ...
    def test_different_title_categories_integration(self):
        ...
        assert "Amazing Spider-Man" in matched_sources, "Control case 'Amazing Spider-Man' did not match"
        
        # Ensure none of the bad match cases matched
        bad_match_titles = [
            "X-Men '92: House Of Xcii", "New X-Men: Academy X", 
            "X-Men Forever 2", "Wolverine", "X-Men"
        ]
