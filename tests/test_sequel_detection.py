...
def test_compare_titles_with_sequels():
    ...
    assert matcher._compare_titles("Civil War", "Civil War II") > 0.5  # Different titles, one has sequel
    assert matcher._compare_titles("Civil War II", "Civil War III") == 0.0  # Different sequels
    assert matcher._compare_titles("Secret Wars 2", "Secret Wars 3") == 0.0  # Different sequels (arabic)
